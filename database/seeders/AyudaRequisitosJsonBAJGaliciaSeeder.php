...
class AyudaRequisitosJsonBAJGaliciaSeeder extends Seeder
{
    public function run(): void
    {
        $requisitos = [
            ...
            [
                'descripcion' => 'Límite de ingresos según unidad de convivencia (Galicia)',
                'json_regla' => json_encode([
                    'condition' => 'OR',
                    'rules' => [
            ...
            [
                'descripcion' => 'Precio alquiler no supera el límite (Galicia)',
                'json_regla' => json_encode([
                    ...
                    'grupos' => [
                        [
                            'nombre' => 'Grupo 1 - Municipios principales',
                            'municipios' => ['A Coruña', 'Santiago de Compostela', 'Vigo', 'Ourense', 'Pontevedra'],
                            'piso_completo' => 700,
                            'habitacion' => 350,
                        ],
                        [
                            'nombre' => 'Grupo 2 - Municipios medianos',
                            'municipios' => ['Ames', 'Arteixo', 'Cambre', 'Carballo', 'Culleredo', 'Ferrol', 'Narón', 'Oleiros', 'Ribeira', 'Lugo', 'Estrada, A', 'Cangas', 'Lalín', 'Marín', 'Porriño, O', 'Ponteareas', 'Redondela', 'Vilagarcía de Arousa'],
                            'piso_completo' => 600,
                            'habitacion' => 300,
                        ],
                        [
                            'nombre' => 'Grupo 3 - Municipios pequeños',
                            'municipios' => ['Ares', 'Pontes de García Rodríguez, As', 'Betanzos', 'Boiro', 'Cedeira', 'Cee', 'Fene', 'Melide', 'Mugardos', 'Neda', 'Noia', 'Ordes', 'Oroso', 'Padrón', 'Pontedeume', 'Sada', 'Teo', 'Burela', 'Cervo', 'Chantada', 'Foz', 'Monforte de Lemos', 'Ribadeo', 'Sarria', 'Vilalba', 'Viveiro', 'Allariz', 'Rúa, A', 'Barco de Valdeorras, O', 'Carballiño, O', 'Celanova', 'Ribadavia', 'Verín', 'Xinzo de Limia', 'Baiona', 'Bueu', 'Cambados', 'Gondomar', 'Grove, O', 'Illa de Arousa, A', 'Moaña', 'Mos', 'Nigrán', 'Poio', 'Pontecesures', 'Sanxenxo', 'Tui', 'Vilanova de Arousa'],
                            'piso_completo' => 500,
                            'habitacion' => 250,
                        ],
                    ],
        ...
        DB::table('ayuda_requisitos_json')->insert([
            'ayuda_id' => 33, // ID de la ayuda BAJ GALICIA
            'descripcion' => 'Requisitos BAJ Galicia',
