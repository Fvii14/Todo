...
class AyudaRequisitosJsonPAVIslasBalearesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $requisitos = [
            [ // -Si la respuesta de la question_id 1 es igual a "Tengo un contrato por habitación." No cumple
                'descripcion' => 'No se admite contrato por habitación en Islas Baleares',
            ...
            [ // -Si la respuesta de la question_id 1 es igual a "Tengo un contrato por habitación." No cumple
                'descripcion' => 'No tener contrato de alquiler firmado',
                'json_regla' => json_encode([
                    'question_id' => 1,
                    'operator' => '!=',
        ...
        DB::table('ayuda_requisitos_json')->insert([
            'ayuda_id' => 22,
            'descripcion' => 'Requisitos para la ayuda de alquiler en Islas Baleares',
