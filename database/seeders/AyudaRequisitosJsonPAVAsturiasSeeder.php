...
class AyudaRequisitosJsonPAVAsturiasSeeder extends Seeder
{
    public function run(): void
    {
        $requisitos = [
            ...
            // No obligatorio si son menores de 36 años
            [
            ...
            [
                'descripcion' => 'Precio del alquiler no supera el límite permitido (Asturias)',
                'json_regla' => json_encode([
        ...
        DB::table('ayuda_requisitos_json')->insert([
            'ayuda_id' => 14,
            'descripcion' => 'Requisitos PAV Asturias',
