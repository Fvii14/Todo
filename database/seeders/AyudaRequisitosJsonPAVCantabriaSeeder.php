...
class AyudaRequisitosJsonPAVCantabriaSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        $requisitos = [
            ...
            [
                ...
                'json_regla' => json_encode([
                    ...
                    'rules' => [
                        ...
                        // Monoparental (carácter general, 25 200 €)
                        [
                            'condition' => 'AND',
                            'rules' => [
                                [
            ...
            [
                'descripcion' => 'Precio del alquiler no supera el límite permitido en Cantabria',
                'json_regla' => json_encode([
        ...
        DB::table('ayuda_requisitos_json')->insert([
            'ayuda_id' => 30,
            'descripcion' => 'Requisitos para la PAV Cantabria',
