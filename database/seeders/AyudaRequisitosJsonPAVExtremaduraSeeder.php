...
class AyudaRequisitosJsonPAVExtremaduraSeeder extends Seeder
{
    public function run(): void
    {
        $requisitos = [
                                    ...
                                    'rules' => [
                                        ...
                                        [
                                            ...
                                            'rules' => [
                                                ...
                                                ['question_id' => 9, 'operator' => 'in', 'value' => ['Familia numerosa']],
                                            ],
                                        ],
                                        [
                                            'condition' => 'AND',
            ...
            [
                'descripcion' => 'Precio del alquiler no supera el límite permitido en Extremadura y La Rioja',
                'json_regla' => json_encode([
                    ...
                    'grupos' => [
                        [
                            'nombre' => 'Extremadura y La Rioja',
                            'municipios' => [], // vacíos, se aplicará por defecto a todos
                            'piso_completo' => 600,
                            'habitacion' => 300,
                            // No se define familia_numerosa_general ni especial
                        ],
                    ],
                    'ajustes_extra' => [
                        'Garaje' => 20,
        ...
        DB::table('ayuda_requisitos_json')->insert([
            'ayuda_id' => 12,
            'descripcion' => 'Requisitos para la PAV Extremadura',
