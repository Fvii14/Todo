...
class AyudaRequisitosJsonBAJAndaluciaSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $requisitos = [
            ...
            [
                'descripcion' => 'Límite de ingresos individuales (máximo 25.200 €, 33.600€ si hay 1 o más convivientes <36)',
                'json_regla' => json_encode([
                    'condition' => 'OR',
                    'rules' => [
                        ...
                        // Tipos D y E → ingresos de la unidad, reglas según número de convivientes
                        [
                            'condition' => 'AND',
                            'rules' => [
                                [
                                ...
                                [
                                    ...
                                    'rules' => [
                                        [
                                            'condition' => 'AND',
                                            'rules' => [
                                                ['question_id' => 6, 'operator' => '==', 'value' => 0],
                                                ['question_id' => 43, 'operator' => '<=', 'value' => 25200],
                                        ...
                                        [
                                            'condition' => 'AND',
                                            'rules' => [
                                                ['question_id' => 6, 'operator' => '>=', 'value' => 1],
            ...
            [
                ...
                'json_regla' => json_encode([
                    ...
                    'grupos' => [
                        [
                            'nombre' => 'Municipios alta demanda Andalucía',
                            'municipios' => [
                                'Cádiz',
                                'Rota',
                                'Granada',
        ...
        DB::table('ayuda_requisitos_json')->insert([
            'ayuda_id' => 25, // ID de la ayuda BAJ Andalucía
            'descripcion' => 'Requisitos BAJ Andalucía',
