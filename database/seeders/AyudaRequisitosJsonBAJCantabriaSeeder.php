...
class AyudaRequisitosJsonBAJCantabriaSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        DB::table('ayuda_requisitos_json')->insert([
            'ayuda_id' => 31, // ID de la ayuda BAJ COMUNIDAD Cantabria
            'descripcion' => 'Requisitos BAJ Cantabria',
