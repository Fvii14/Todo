...
class PAVsCatalunyaSeeder extends Seeder
{
    public function run(): void
    {
        $questionnaire1Id = DB::table('questionnaires')->insertGetId([
            'name' => 'Programa Estatal de Vivienda Cataluña +36 <65',
            'active' => 1,
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now(),
            'tipo' => 'pre',
            'redirect_url' => null,
            'slug' => 'pav_cataluna_mas_36_menos_65',
            'ayuda_id' => null,
        ]);

        $questionnaire2Id = DB::table('questionnaires')->insertGetId([
            'name' => 'Programa Estatal de Vivienda Cataluña +65',
            'active' => 1,
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now(),
            'tipo' => 'pre',
            'redirect_url' => null,
            'slug' => 'pav_cataluna_mas_65',
            'ayuda_id' => null,
        ]);

        $ayuda1Id = DB::table('ayudas')->insertGetId([
            'nombre_ayuda' => 'Programa Estatal de Vivienda Cataluña +36 <65',
            'sector' => 'vivienda',
            'create_time' => null,
            ...
            'description' => 'Ayuda al alquiler dirigida a personas entre 36 y 64 años con contrato en vigor y empadronamiento en la vivienda. Cubre del 20 % al 40 % del alquiler anual 2025, hasta un máximo de 3.000 € por solicitante.\nNo se puede superar el 75 % del alquiler total si hay más de un solicitante en la vivienda.\nSe valoran los ingresos anuales y el esfuerzo económico.\nPrioridad para: VPO, personas solas, discapacidad, menores a cargo.\nRequiere estar al corriente de pagos, no tener vínculos familiares con el arrendador, y no ser propietario (con excepciones).',
            'organo_id' => 2,
            'activo' => 1,
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now(),
        ...
        $ayuda2Id = DB::table('ayudas')->insertGetId([
            'nombre_ayuda' => 'Programa Estatal de Vivienda Cataluña +65',
            'sector' => 'vivienda',
            'create_time' => null,
            ...
            'fecha_inicio_periodo' => '2025-01-01',
            'fecha_fin_periodo' => '2025-12-31',
            'description' => 'Ayuda para personas de 65 años o más con contrato de alquiler o cesión de uso vigente y empadronamiento en la vivienda.\nNo se permite aportar el contrato tras la solicitud.\nLa subvención cubre entre el 20 % y 40 % del alquiler anual, con un límite de 2.400 € por solicitante, en función del esfuerzo económico ponderado.',
            'organo_id' => 2,
            'activo' => 1,
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now(),
        ...
        DB::table('questionnaires')->where('id', $questionnaire1Id)->update(['ayuda_id' => $ayuda1Id]);
        DB::table('questionnaires')->where('id', $questionnaire2Id)->update(['ayuda_id' => $ayuda2Id]);
        ...
        foreach ($preguntasAmbosPAVs as $key => $value) {
        ...
        $requisitos = [
            ...
            [
                ...
                'descripcion' => 'Tener más de 36 años',
                'json_regla' => json_encode([
                    'condition' => 'AND',
                    'rules' => [
                        [
            ...
            [
                'descripcion' => 'Tener menos de 65 años',
                'json_regla' => json_encode([
                    'condition' => 'AND',
                    'rules' => [
                        [
        ...
        DB::table('ayuda_requisitos_json')->insert([
            ...
            'descripcion' => 'Requisitos PAV Catalunya +36 <65',
        ...
        $requisitos = [
            ...
            [
                ...
                'descripcion' => 'Tener más de 65 años',
                'json_regla' => json_encode([
                    'condition' => 'AND',
                    'rules' => [
                        [
        ...
        DB::table('ayuda_requisitos_json')->insert([
            ...
            'descripcion' => 'Requisitos PAV Catalunya +65',
            'json_regla' => json_encode($requisitos),
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now(),
        ]);
