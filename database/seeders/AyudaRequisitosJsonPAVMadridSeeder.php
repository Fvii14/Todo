...
class AyudaRequisitosJsonPAVMadridSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        $requisitos = [
            ...
            // //___MADRID___ARAGÓN___CASTILLA Y LEÓN___GALICIA____ (Límite de ingresos)
            [
                ...
                'json_regla' => json_encode([
                    ...
                    'rules' => [
                        ...
                        [   // Usuarios que viven solos y con grupo vulnerables = violencia de genero,familia numerosa especial y pretaciones agotadas
                            'condition' => 'AND',
                            'rules' => [
                                ['question_id' => 1, 'operator' => 'in', 'value' => [
                                    'Vivo de alquiler en una vivienda completa y vivo sola/o.',
                        ...
                        [   // Usuarios que viven con convivientes y con grupo vulnerables = violencia de genero,familia numerosa especial y pretaciones agotadas
                            'condition' => 'AND',
                            'rules' => [
                                ['question_id' => 1, 'operator' => 'in', 'value' => [
                                    'Vivo de alquiler en una vivienda y todas las personas forman parte del contrato.',
            ...
            // ___MADRID___MURCIA___ASTURIAS___

            // 		-Si 'question_id' => 40, 'operator' => 'less_than_years', 'value' => 36 entonces
            // 		la respuesta de la question_id 1 es igual a "Todavía no tiene contrato" cumple
            // OR
            // 		 ['question_id' => 1, 'operator' => 'in', 'value' => [
            //                             'Vivo de alquiler en una vivienda completa y vivo sola/o.',
            //                             'Tengo un contrato por habitación.',
            ...
            // ___MADRID____MURCIA____ASTURIAS___LA RIOJA___
        ...
        DB::table('ayuda_requisitos_json')->insert([
            'ayuda_id' => 28, // ID de la ayuda PAV Madrid
            'descripcion' => 'Requisitos PAV Madrid',
