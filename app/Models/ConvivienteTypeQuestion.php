...
class ConvivienteTypeQuestion extends Model
{
    protected $fillable = [
        'onboarder_id',
        'conviviente_type_section_id',
        'question_id',
        'order',
        'screen',
        'condition',
    ...
    {
        return $this->belongsTo(ConvivienteTypeSection::class, 'conviviente_type_section_id');
    }
    ...
    {
        return $query->where('conviviente_type_section_id', $sectionId);
    }
    ...
    {
        if ($this->hasRequiredCondition() && isset($this->required_condition['isDefault']) && $this->required_condition['isDefault'] === true) {
            return true;
        }
