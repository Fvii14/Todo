    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="mb-8">
        <div class="flex items-center mb-4">
          ...
          <div>
            <h2 class="text-2xl font-bold text-gray-900">Preguntas del Cuestionario</h2>
            <p class="text-gray-600">Define las preguntas que se mostrarán a los usuarios</p>
          </div>
        </div>
      </div>
        ...
        <div class="flex">
          ...
          <div class="ml-3">
            ...
            <div class="mt-2 text-sm text-yellow-700">
              <p>El editor de preguntas está siendo implementado. Por ahora, puedes continuar al siguiente paso.</p>
            </div>
          </div>
        </div>
      </div>
