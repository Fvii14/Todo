    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="mb-8">
        <div class="flex items-center mb-4">
          ...
          <div>
            <h2 class="text-2xl font-bold text-gray-900">Condiciones de Preguntas</h2>
            <p class="text-gray-600">Define la lógica condicional para mostrar u ocultar preguntas</p>
          </div>
        </div>
      </div>
        ...
        <div class="flex">
          ...
          <div class="ml-3">
            ...
            <div class="mt-2 text-sm text-yellow-700">
              <p>El editor de condiciones está siendo implementado. Por ahora, puedes continuar al siguiente paso.</p>
            </div>
          </div>
        </div>
      </div>
