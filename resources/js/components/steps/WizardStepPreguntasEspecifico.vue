<template>
    <div>
        <h3 class="text-xl font-semibold text-gray-900 mb-6">
            ...
            Preguntas del Formulario Específico
        </h3>
        ...
        <div v-if="questions.length > 0">
            ...
            <div class="space-y-3">
                <div
                    ...
                    class="space-y-2 questions-container-specific"
                    @dragover.prevent
                    @drop="handleDrop"
                >
                    <div
                        ...
                        @click="$emit('question-click', index)"
                        @dragover="$emit('drag-over', index)"
                        ...
                        :class="[
                            ...
                            isDragging && draggedIndex === index
                                ...
                                : '',
                            dragOverIndex === index ? 'drag-over' : 'border-gray-200',
...
// Referencia al contenedor de preguntas
const questionsContainer = ref(null)

// Manejar el drop y pasar el contenedor en el evento
const handleDrop = (event) => {
    event.preventDefault()
    // Pasar el evento junto con la referencia al contenedor
    emit('drop', {
        event,
        container: questionsContainer.value,
    })
}
